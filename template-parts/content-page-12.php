...
<div class="entry-content">
	<div class="container-fluid">
		<div class="row">
			<div class="doula hero" "small-12 large-12 columns">
				<div class="doulas small-6 small-offset-6 columns"><br>
	...
	<div class="row">
  		<div class="doula services small-6 large-6 columns">
  			...
  			<p><strong>You can expect your doula team to:</strong></p>
				...
				<center><a href="#" class="button success">Purchase Now</a><a href="#" class="button secondary">Contact Us</a></center>
  				<hr />
  				<br>
  		...
  		<div class="doula image large-5 large-offset-1 columns">
